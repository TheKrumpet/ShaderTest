...
public class ShaderTestGame : Game
{
    ...
    protected override void LoadContent()
    {
        ...
        _shadowMap = new RenderTarget2D(GraphicsDevice, 4096, 4096, false, SurfaceFormat.Single, DepthFormat.Depth16, 0, RenderTargetUsage.PlatformContents)
        {
            Name = "ShadowMap"
        };
        ...
        _currentRenderer = pbrDeferredRenderer;
    }
